...
$purposes=mysqli_query($connection,"SELECT  * FROM `purposes` where type='both' or type='deposit'");
 ?> 
    ...
    <form action="view_yearly_purpose_deposit.php" id="select_form" method="GET">
	<p align="center" style="color: #F00; font-size: 1.2em;">Show Yearly Purpose Based Deposits</p>
	<p>
	...
	if(isset($_GET['submit'])) { 
		...
		if(!$num_rows){?>
			<div id="search_result">
				No Deposits in <b><?php echo $purpose.' ['.$year.' ]'?></b>
			</div>
			<br>
			<br>
		<?php 
...
<table class="all-table min-broad">
	<caption class="caption">Deposit Information For <b><?php echo $purpose.' ['.$year.' ]'?></b></caption>
	<tr>
	...
	?>
		<tr>
			...
			<td>
				<a href="view_monthly_purpose_deposit.php?purpose=<?php echo $purpose?>&year=<?php echo $year?>&month=<?php echo intval($month)?>&submit=Search">
